 ...
 */
function fsm(sounds, channel, dependencies) {
    ...
    states : {
      ...
      'init' : {
        _onEnter: function() {
          ...
          ari.getClient(ariConfig.url, ariConfig.username, ariConfig.password,
                        ariConfig.applicationName)
 ...
 */
function createPrompt(sounds, channel, dependencies) {
  var state = fsm(sounds, channel, dependencies);
...
module.exports = function(dependencies) {
  return {
    create: function(sounds, channel) {
      return createPrompt(sounds, channel, dependencies);
    }
  };
};
