    ...
    states : {
      ...
      'init' : {
        _onEnter: function() {
          ...
          ari.getClient(appConfig.ari.url, appConfig.ari.username,
                        appConfig.ari.password, appConfig.ari.applicationName)
 ...
 */
function create(sounds, channel) {
  var state = fsm(sounds, channel);
